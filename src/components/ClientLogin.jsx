...
const ClientSignup = () => {
  ...
  const onSubmit = async (data, e) => {
    ...
    if (!isValid) {
      ...
      try {
        axios.post(`${import.meta.env.VITE_BASE_URL}/client/login`, data)
        .then((res) => {
  ...
  return (
    <div className="w-full mt-12 flex justify-center">
      ...
      >
        ...
        <p className="hover:underline text-red-600 cursor-pointer pb-4" onClick={() => navigate('/client/signup')}>Signup</p>
      </form>
    </div>
  );
};
